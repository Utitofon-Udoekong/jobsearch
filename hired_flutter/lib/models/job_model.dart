...
class Job with _$Job {
  const factory Job({
    ...
    @JsonKey(name: 'job_is_remote') String? jobIsRemote,
    @JsonKey(name: 'job_posted_at_timestamp') String? jobPostedatTimestamp,
    ...
    @JsonKey(name: 'job_min_salary') String? jobMinSalary,
    @JsonKey(name: 'job_max_salary') String? jobMaxSalary,
